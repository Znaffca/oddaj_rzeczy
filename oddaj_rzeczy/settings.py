...
SECRET_KEY = '^f*uzj1l65+@kf#(vzr^6u5667_lmi&-%4q-t4^-^um^)e3tl5'
...
# DATABASES MOVED TO LOCAL_SETTINGS
...
try:
    from oddaj_rzeczy.local_settings import DATABASES, EMAIL_HOST_PASSWORD, EMAIL_HOST_USER
